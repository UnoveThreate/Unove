    package DAO.owner.canteenItemDAO;
     ...
     */
    public class CanteenItemManageDAO extends MySQLConnect {

        public CanteenItemManageDAO(ServletContext context) throws Exception {
            super();
            connect(context);
        }
