    ...
    <body>
        <div class="container">
            ...
            <%
                ...
                if (amountString != null) {
                    try {
                        ...
                        e.printStackTrace(); // Handle the exception (you might want to log this or show an error)
                    }
                }
            %>
            ...
            <div style="text-align: center;">
                <button class="btn" onclick="window.location.href = '<%= RouterURL.HOME_PAGE%>';">Quay lại Trang chủ</button>
            </div>
