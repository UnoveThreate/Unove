                    ...
                    <body>
                        <div class="container">
                            ...
                            <div class="movie-details" data-aos="fade-left">
                                ...
                                <div class="metadata">
                                    <div>Published: <strong>
                                            <%= movie.getDatePublished()%>
                                        </strong></div>
                                    <div>Genre: <strong>
                                    ...
                                    <c:if test="${sessionScope.role ne 'OWNER'}">
                                        ...
                                        <c:if test="${isFavoritedMovie == false}">
                                            <form action="HandleDisplayMovieInfo" method="post">
                                                ...
                                                <!-- Include the movieID -->
                                                <button id="favourite" type="submit"
                                        ...
                                        <c:if test="${isFavoritedMovie == true}">
                                            <form action="myfavouritemovie" method="post">
                                                ...
                                                <button id="unFavourite" type="submit"
                                                    style="display: inline-block; text-decoration: none; cursor: pointer; margin-left: -25px; background: none; border: none; padding: 0;">
                                                    <span class="clWhite">
                                    ...
                                    <div class="button-group" id="cinemaChainButtons">
                                        <c:forEach var="chain" items="${cinemaChains}">
                                            <button
                                                ...
                                                <img src="${chain.avatarURL}" alt="${chain.name}"
                                                    class="cinema-chain-avatar" onerror="this.style.display='none';" />
                                ...
                                <div class="selector" data-aos="fade-up" data-aos-delay="200">
                                    ...
                                    <div class="cinema-list" id="cinemaButtons">
                                        <c:forEach var="cinema" items="${chainCinemas[selectedCinemaChainID]}">
                                            <button
                                                class="cinema-item ${cinema.cinemaID == selectedCinemaID ? 'active' : ''}"
                                                data-id="${cinema.cinemaID}" onclick="selectCinema(${cinema.cinemaID})">
