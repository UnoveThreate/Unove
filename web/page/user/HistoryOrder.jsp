...
<html lang="vi">
    ...
    <body>
        <div class="container">
                    ...
                    <tbody>
                        <c:forEach var="order" items="${historyOrders}">
                            <tr>
                                ...
                                <!-- Chỉ hiển thị ngày của ShowTime -->
                                <td>
                                    <fmt:formatDate value="${order.ShowTime}" pattern="yyyy-MM-dd" />
                                </td>
                                <!-- Chỉ hiển thị giờ và phút của ShowTime -->
                                <td>
                                    <fmt:formatDate value="${order.ShowTime}" pattern="HH:mm" />
                                </td>
            ...
            <form action="${pageContext.request.contextPath}/history" method="post" style="text-align: center; margin-top: 20px;">
                <button type="submit" name="action" value="back" class="back-link">Trở về trang chủ</button>
            </form>
        </div>
    </body>
</html>
