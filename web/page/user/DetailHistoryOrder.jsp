...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            .qr-section .status-confirmed {
                color: white;
                border: 1px solid #c3e6cb;
                background: linear-gradient(90deg, #ff8fab 0%, #ff5d8f 100%);
            }

            .qr-section .status-success {
    ...
    <body>
        ...
        <div class="ticket-container" data-aos="fade-up" data-aos-duration="1000">
            <div class="ticket-header" data-aos="fade-down" data-aos-duration="1000">Chi tiết lịch sử đơn hàng</div>
            <div class="ticket-content">
                <!-- Movie Info Section -->
                <div class="info-section" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">
                    <div class="movie-title">
                        <h2 data-aos="fade-up" data-aos-delay="300">
                            <c:out value="${orderDetail.movieTitle}" default="Chưa có thông tin phim"/>
                        </h2>
                    </div>
                        ...
                        <ul>
                            <li>
                                <c:if test="${not empty orderDetail}">
                                    <fmt:formatDate value="${orderDetail.startTime}" pattern="HH:mm" /> - 
                                    <fmt:formatDate value="${orderDetail.endTime}" pattern="HH:mm" />
                                </c:if>
                    ...
                    <div class="info-block" data-aos="fade-up" data-aos-delay="450">
                        ...
                        <ul>
                            <li>
                                <c:if test="${not empty orderDetail}">
                                    <fmt:formatDate value="${orderDetail.startTime}" pattern="dd/MM/yyyy" />
                                </c:if>
                    ...
                    <div class="info-block" data-aos="fade-up" data-aos-delay="500">
                        ...
                        <ul>
                            <li><c:out value="${orderDetail.cinemaName}" default="Chưa có thông tin rạp"/></li>
                        </ul>
                    </div>
                    ...
                    <div class="info-block" data-aos="fade-up" data-aos-delay="550">
                        ...
                        <ul>
                            <li>
                                <c:out value="${orderDetail.address}" default=""/>
                                <c:if test="${not empty orderDetail.address}">, </c:if>
                                <c:out value="${orderDetail.province}" default=""/>
                                <c:if test="${not empty orderDetail.province}">, </c:if>
                                <c:out value="${orderDetail.district}" default=""/>
                                <c:if test="${not empty orderDetail.district}">, </c:if>
                                <c:out value="${orderDetail.commune}" default=""/>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="info-block" data-aos="fade-up" data-aos-delay="600">
                        ...
                        <ul>
                            <li><c:out value="${orderDetail.roomName}" default="Chưa có thông tin"/></li>
                        </ul>
                    </div>
                    ...
                    <div class="info-block" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <ul>
                            <c:forEach var="item" items="${selectedCanteenItems}">
                                <li><c:out value="${item.name}" /> - Số lượng: <c:out value="${item.quantity}" /></li>
                                </c:forEach>
                        </ul>
                    </div>
                ...
                <div class="qr-section" data-aos="fade-left" data-aos-delay="200">
                    ...
                    <c:choose>
                        <c:when test="${not empty qrCodeUrl}">
                            <!-- Display the QR code image from the QR code URL -->
                            <img src="${qrCodeUrl}" 
                                 alt="QR Code" 
                    ...
                    <p class="status 
                       <c:choose>
                           <c:when test="${status == 'Confirmed'}">status-confirmed</c:when>
                           <c:when test="${status == 'success'}">status-success</c:when>
                       </c:choose>">
